  ...
  <header class="entry-header">
    ...
    <p class="byline bypostauthor">
      <?php
        ...
        $byLine = '<span class="post-date"><time class="updated" datetime="' . $date . '">' . $date . '</time></span>';
        $byLine .= '<span class="post-author"> | <a href="' . get_author_posts_url( get_the_author_meta('ID') ) . '">' . get_the_author_meta('display_name') . '</a></span>';
        echo $byLine;
      ?>
    </p>
  </header>
